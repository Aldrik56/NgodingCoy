...
<nav class="navbar navbar-expand-lg" style="background-color:white">
    ...
    <div class="container">
        <div class="d-flex justify-content-around mt-5">
            <div class="w-50">
                <img style="height: 100px;" src="img/logo.png" data-aos="zoom-in"data-aos-duration="1000"/>
            ...
            <div class="d-flex flex-column align-items-center p-3" data-aos="zoom-in"data-aos-duration="1000" style="width: 40%; background-color: #F2F2F2; border: 1px solid #FFB800;border-bottom: 5px solid #FFB800; border-right: 5px solid #FFB800; border-radius: 15px;">
